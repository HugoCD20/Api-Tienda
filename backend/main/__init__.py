...
def create_app():
    ...
    api.add_resource(resourcest.direccionesResources,'/direcciones')
    api.add_resource(resourcest.direccionResources,'/direccion/<id>')
    api.add_resource(resourcest.carritosResources,'/carrito')
    api.add_resource(resourcest.carritoResources,'/carritp/<id>')
    api._init_app(app)
